...
public class OidcMetaDataTestImpl implements OidcMetaData {
    ...
    private OIDCProviderMetadata createMockOIDCProviderMetadata() {
        ...
        metadata.setIntrospectionEndpointURI(URI.create("http://localhost:8089/oauth2/introspect"));
        
        // Debug: Verify the introspection endpoint is set
        System.out.println("Setting introspection endpoint: " + metadata.getIntrospectionEndpointURI());
    ...
    public OIDCProviderMetadata getOpMetadata() {
        // Debug: Check if introspection endpoint is still set
        System.out.println("Getting op metadata, introspection endpoint: " + opMetadata.getIntrospectionEndpointURI());
        return opMetadata;
    }
