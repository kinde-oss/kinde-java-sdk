...
final class ReactiveKindeOidcUserService extends OidcReactiveOAuth2UserService {
    ...
    ReactiveKindeOidcUserService(Collection<AuthoritiesProvider> authoritiesProviders) {
        this(authoritiesProviders, new ReactiveKindeOAuth2UserService(authoritiesProviders));
    }

    ReactiveKindeOidcUserService(Collection<AuthoritiesProvider> authoritiesProviders, ReactiveOAuth2UserService<OAuth2UserRequest, OAuth2User> oauth2UserService) {
