...
public class ReactiveKindeOAuth2UserServiceTest {

    @Test
    public void testLoadUser() {
        ReactiveOAuth2UserService reactiveOAuth2UserService = Mockito.mock(ReactiveKindeOidcUserService.class);
        KindeSdkClient kindeSdkClient = Mockito.mock(KindeSdkClient.class);
        ReactiveKindeOidcUserService reactiveKindeOidcUserService = new ReactiveKindeOidcUserService(List.of(),reactiveOAuth2UserService,kindeSdkClient);
