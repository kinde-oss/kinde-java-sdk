...
@JsonTypeName("organization_user")
...
public class OrganizationUser {
    ...
    public OrganizationUser lastName(String lastName) {
    ...
    public OrganizationUser firstName(String firstName) {
    ...
    public OrganizationUser roles(List<String> roles) {
        this.roles = roles;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, organizationUser.id) &&
                ...
                Objects.equals(this.lastName, organizationUser.lastName) &&
                Objects.equals(this.firstName, organizationUser.firstName) &&
                Objects.equals(this.roles, organizationUser.roles);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, email, fullName, lastName, firstName, roles);
    }
