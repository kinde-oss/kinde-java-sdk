...
//        }
        ...
        if (additionalParameters.containsKey("org_code")){
            throw new IllegalArgumentException("The org_code is automatically generated by Kinde, so you cannot PUT an org_code for an Org");
        }
